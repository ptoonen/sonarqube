...
import org.sonar.server.computation.step.PopulateComponentUuidsStep;
...
public interface Component {
  ...
  /**
   * Return the component uuid only when {@link PopulateComponentUuidsStep} has been executed, otherwise it will throw an exception.
   */
  String getUuid();

  /**
   * Return the component key only when {@link PopulateComponentUuidsStep} has been executed, otherwise it will throw an exception.
   */
  String getKey();
